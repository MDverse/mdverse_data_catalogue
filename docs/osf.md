...
1. For each dataset, retrieve [information](https://api.osf.io/v2/nodes/pdszh/) and [files list](https://api.osf.io/v2/nodes/pdszh/files/).
1. [Retrieve files information](https://api.osf.io/v2/nodes/pdszh/files/osfstorage/). Results are paginated.
...
Note: we cannot easily catch the content of zip files as displayed by OSF since the overview is Javascript based. See for instance the source of the page with the content of [`AllModel.zip`](https://osf.io/p7wmj).
