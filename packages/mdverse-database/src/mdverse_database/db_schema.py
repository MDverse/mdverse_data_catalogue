"""Database schema for the MDverse database."""
...
class Dataset(SQLModel, table=True):
    ...
    url_in_data_source: str | None = Field(default=None)
    project_id: int | None = Field(default=None, foreign_key="projects.project_id")
    id_in_project: str | None = Field(default=None)
    url_in_project: str | None = Field(default=None)
    doi: str | None = Field(default=None)
    date_created: str | None = None  # YYYY-MM-DD format
    date_last_modified: str | None = None  # YYYY-MM-DD format
...
class File(SQLModel, table=True):
    ...
    size_in_bytes: float | None = Field(default=None)
    ...
    parent_zip_file_id: int | None = Field(
    ...
    parent: Optional["File"] = Relationship(
        ...
        sa_relationship_kwargs={"remote_side": "File.file_id"},
    ...
    annotation: list["Annotation"] | None = Relationship(
        back_populates="file", cascade_delete=True
    )
...
class Annotation(SQLModel, table=True):
    ...
    file_id: int | None = Field(foreign_key="files.file_id", default=None)
    paper_id: int | None = Field(foreign_key="papers.paper_id", default=None)
    value: str
    quality_score: str | None = Field(default=None)
    value_extra: str | None = Field(default=None)
...
class Molecule(SQLModel, table=True):
    ...
    # Attributes/Table columns -----------------------------------------------
    molecule_id: int | None = Field(default=None, primary_key=True)
    annotation_id: int = Field(foreign_key="annotations.annotation_id")
    name: str
    formula: str
    sequence: str
    molecule_type_id: int | None = Field(foreign_key="molecule_types.molecule_type_id")

    # Relationships: annotations, molecule_types, molecules_external_db ------
    annotation: "Annotation" = Relationship(back_populates="molecule")
    mol_ext_db: list["MoleculeExternalDb"] | None = Relationship(
...
class MoleculeExternalDb(SQLModel, table=True):
    """MoleculeExternalDb table."""

    __tablename__ = "molecules_external_db"

    # Attributes/Table columns -----------------------------------------------
    mol_ext_db_id: int | None = Field(default=None, primary_key=True)
    molecule_id: int = Field(foreign_key="molecules.molecule_id")
    db_name: str = Field(index=True)
    id_in_external_db: str
    database_id: int | None = Field(foreign_key="databases.database_id")
...
class ParameterFile(SQLModel, table=True):
    ...
    dt: float | None = Field(default=None)
    nsteps: int | None = Field(default=None)
    temperature: float | None = Field(default=None)
    thermostat: str | None = Field(default=None)
    barostat: str | None = Field(default=None)
...
class FileType(SQLModel, table=True):
    ...
    file_type_id: int | None = Field(default=None, primary_key=True)
    name: str = Field(unique=True)
    comment: str | None = Field(default=None)
...
class MoleculeType(SQLModel, table=True):
    ...
    molecule_type_id: int | None = Field(default=None, primary_key=True)
    name: str = Field(unique=True)
    comment: str | None = Field(default=None)
...
class DataSource(SQLModel, table=True):
    ...
    data_source_id: int | None = Field(default=None, primary_key=True)
    name: str = Field(unique=True)
    url: str | None = Field(default=None)
    citation: str | None = Field(default=None)
    comment: str | None = Field(default=None)
...
class ProvenanceType(SQLModel, table=True):
    """ProvenanceType table."""

    __tablename__ = "provenance_types"

    provenance_id: int | None = Field(default=None, primary_key=True)
    name: str = Field(unique=True)
    comment: str | None = Field(default=None)
...
class AnnotationType(SQLModel, table=True):
    ...
    annotation_type_id: int | None = Field(default=None, primary_key=True)
    label: str
    name: str
    comment: str | None = Field(default=None)
