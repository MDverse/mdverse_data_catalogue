"""Query the database and print information."""
...
def print_data_source_summary():
    ...
    the first dataset creation date,
    ...
    with Session(engine) as session:
        ...
        for row in results:
            ...
            first_date = row.first_dataset or "None"
            last_date = row.last_dataset or "None"
            print(
...
def random_mdp_information():
    ...
    with Session(engine) as session:
        ...
        random_row = random.choice(results)  # noqa: S311
    ...
    with Session(engine) as session:
        ...
        if results:
            ...
            for dataset in results:
                ...
                print(f"Dataset ID in origin: {dataset.id_in_data_source}")
                print(f"Origin: {dataset.id_in_data_source}")
            print("\n")
