"""Integrate parameter files data into the database."""
...
def delete_files(engine: Engine) -> None:
    ...
    with Session(engine) as session:
        ...
        session.commit()
    logger.info(
        f"Total rows from PARAMETER_FILES deleted: {result_parameter.rowcount}\n"
    )
...
def data_ingestion():
    """Ingest parameter files data into the database."""
